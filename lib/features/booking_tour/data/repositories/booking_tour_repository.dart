...
import 'package:kyrgyz_tourism/features/booking_tour/data/api_service/booking_tour_api_service.dart';

import 'package:kyrgyz_tourism/features/booking_tour/data/models/booking_tour_model.dart';
import 'package:kyrgyz_tourism/features/booking_tour/domain/repositories/booking_domain_repository.dart';
...
class BookingTourRepository extends BookingDomainRepository {
  ...
  Future<List<BookingTourModel>> bookingDate(BookingDateParams params) async {
    return _bookingTourApi.bookingDate(params);
  }

  @override
  Future<List<BookingTourModel>> bookingUser() async {
    return _bookingTourApi.bookingUser();
  }
}

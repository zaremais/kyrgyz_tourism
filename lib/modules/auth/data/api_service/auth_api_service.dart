...
//   Future<void> signup(@Body() SignUpParams params);

//   @GET('/v1/api/verify')
//   Future<void> verifyCode(@Query('code') String code);

//   @GET('/v1/api/exists/{nickname}')
//   Future<bool> checkNickname(@Path('nickname') NickNameParams params);
...
//   Future<void> updateProfile(@Body() ProfileParams params);
...
//   // @POST('/v1/api/otp/confirm')
//   // Future<TelegramConfirmModel> telegramLogin(@Body() ConfirmOtpParams params);
// }
